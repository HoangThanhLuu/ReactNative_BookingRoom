...
import SearchResults from '../conponent/SearchResults';

//khi người dùng bấm vào nhập điểm đến 
const SearchScreen = () => {
    const [input,setInput] = useState("");//dùng để lấy dữ liệu trong thanh Input
    // console.log(input);//khi nhập gì trong thanh TextInput thì nó sẽ hiển thị
    ...
    const data = [
        ...
        properties: [
          {
            ...
            //giá mới (mới)
            newPrice: 3312,
            latitude: "10.812581595511885",
            longitude: "106.7474861133035",
            photos: [
              {
                id: "100",
                image:
      ...
      //dữ liệu 2
      {
        ...
        place: "Hà Nội",
        placeImage:
          "https://media.istockphoto.com/id/496971615/vi/anh/c%E1%BA%A3nh-quan-th%C3%A0nh-ph%E1%BB%91.jpg?s=612x612&w=0&k=20&c=LtE_u-Z6SYC04MJbA-Axx6mrmdo9qJ7IQQWLrgttgCQ=",
      ...
      //dữ liệu 3
      {
        ...
        place: "Đà Nẵng",
        placeImage:
          "https://media.istockphoto.com/id/1154902356/vi/anh/c%E1%BA%A7u-r%E1%BB%93ng-%C4%91%C3%A0-n%E1%BA%B5ng-l%C3%BAc-ho%C3%A0ng-h%C3%B4n.jpg?s=612x612&w=0&k=20&c=c0G92jqGaR62kHFBuV6BSoxL6RCxb7FtW2C9fqbj32U=",
        shortDescription: "Thành phố Đà nẵng,Việt Nam",
        properties: [
          {
            id: "20",
  ...
  return (
    <SafeAreaView>
        <View style={{marginTop:10,padding:10,flexDirection:'row',justifyContent:'space-between',borderRadius:15,borderColor:'#15ACBB',borderWidth:3}}>
            {/*khi textInput(mình nhập setInput set lấy dữ liệu) có dữ liệu gì thì value có dữ liệu đó ,value={input} dùng để lưu dữ liệu của văn bản khi nhập vào TextInput để có thể sử dụng prop */}
            <TextInput value={input} onChangeText={(dl) => setInput(dl)} placeholder='Nhập điểm đến của Quý khách'></TextInput>  
        <FontAwesome name="search" size={24} color="black" />
        
        </View>

    {/* tại vì dữ liệu lặp đi lặp lại(sẽ có ảnh và chữ hiển thị) nên phải dùng prop  */}
    {/*input và setInput dùng để lấy dữ liệu nhập từ thanh Input qua bên kia để kiểm tra xem có trùng với dữ liệu trong data ,nếu trùng thì mới hiển thị hình ảnh và chữ */}
